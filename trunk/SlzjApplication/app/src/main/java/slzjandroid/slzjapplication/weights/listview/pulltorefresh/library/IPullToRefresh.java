 ...
 *******************************************************************************/
package slzjandroid.slzjapplication.weights.listview.pulltorefresh.library;

import android.view.View;
import android.view.animation.Interpolator;

import slzjandroid.slzjapplication.weights.listview.pulltorefresh.library.PullToRefreshBase.Mode;
import slzjandroid.slzjapplication.weights.listview.pulltorefresh.library.PullToRefreshBase.OnPullEventListener;
import slzjandroid.slzjapplication.weights.listview.pulltorefresh.library.PullToRefreshBase.OnRefreshListener;
import slzjandroid.slzjapplication.weights.listview.pulltorefresh.library.PullToRefreshBase.OnRefreshListener2;
import slzjandroid.slzjapplication.weights.listview.pulltorefresh.library.PullToRefreshBase.State;
