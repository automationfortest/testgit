 ...
 * 
 */
public class MemberManualaddAdapter extends BaseAdapter {
	private List<DeptInfo> data = new ArrayList<DeptInfo>();
	private Context mContext;
	public static int mSelectIndex = -1;
	public MemberManualaddAdapter(Context context, List<DeptInfo> data) {
