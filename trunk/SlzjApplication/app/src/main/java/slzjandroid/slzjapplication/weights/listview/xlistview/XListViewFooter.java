...
public class XListViewFooter extends LinearLayout {
	...
	public void setState(int state) {
		...
		if (state == STATE_READY) {
			...
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(mContext
					.getString(R.string.xlistview_footer_hint_no_more));
		} else {
			mHintView.setVisibility(View.VISIBLE);
			mHintView.setText(mContext
	...
	public void setColor(int color) {
		moreView.setBackgroundResource(color);
	}
...
////		AnimationDrawable animationDrawable = (AnimationDrawable) mProgressBar
////				.getDrawable();
